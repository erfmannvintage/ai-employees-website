          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <div style={{ background: 'rgba(255,255,255,0.06)', borderRadius: 8, padding: '8px 14px', display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div><div style={{ fontSize: 8, color: 'rgba(255,255,255,0.4)' }}>Coming soon</div><div style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.6)' }}>App Store</div></div>
              </div>
              <div style={{ background: 'rgba(255,255,255,0.06)', borderRadius: 8, padding: '8px 14px', display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div><div style={{ fontSize: 8, color: 'rgba(255,255,255,0.4)' }}>Coming soon</div><div style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.6)' }}>Google Play</div></div>
              </div>
            </div>
          </div>
