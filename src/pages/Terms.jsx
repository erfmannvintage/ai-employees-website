export default function Terms() {
  const sections = [
    { t: '1. Agreement', c: 'By using Sidekicc you agree to these Terms. If not, don\'t use the Service.' },
    ...
    { t: '7. IP', c: 'Service owned by Sidekicc. Subscription grants limited, non-exclusive, non-transferable licence.' },
    ...
    { t: '12. Contact', c: 'legal@sidekicc.com' },
  ]
