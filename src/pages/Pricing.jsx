      ...
      <section style={{ background: '#fff', padding: '60px 0' }}>
        <div style={{ ...cx, textAlign: 'center', maxWidth: 700 }}>
          ...
          <p style={{ fontSize: 17, color: '#6b6b8d', lineHeight: 1.7 }}>
            Some AI platforms use credit-based pricing where your monthly allowance can vanish in a couple of hours. Users describe it as feeling punished for actually using the product. We think that's wrong. You should know exactly what you get each month — <strong style={{ color: '#1a1a2e' }}>500, 5,000, or unlimited tasks</strong>. Simple. Predictable. No surprises.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: '#fff', padding: '80px 0' }}>
        <div style={cx}>
          ...
          <div style={{ textAlign: 'center', marginTop: 40 }}>
            <a href="https://app.sidekicc.com" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#6C3AFF', color: '#fff', fontWeight: 600, fontSize: 17, borderRadius: 14, padding: '18px 40px', textDecoration: 'none', boxShadow: '0 4px 20px rgba(108,58,255,0.3)' }}>
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            {[
              ...
              { q: 'Why are you cheaper than competitors?', a: 'We offer more features — cross-collaboration, content chains, self-learning, lead discovery, finance, legal, voice and vibe mode — at a lower price point. Our Growth plan gives you capabilities that competitors charge 2-3x more for. And we don\'t use credits.' },
