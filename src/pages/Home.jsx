...
function WhatYouGet() {
  const tools = [
    ...
    { title: 'Data Hub & Custom Skills', desc: 'Upload any file type — documents, PDFs, spreadsheets, images, voice notes, sales call recordings, competitor research, marketing materials. Employees reference everything in every task. Then teach them YOUR workflows with Custom Skills: "When a lead comes in, do X then Y then Z." Stored permanently in their Brain.' },
...
function FAQ() {
  const faqs = [
    ...
    { q: 'How do the employees learn my business?', a: 'Three ways: your Business Profile (100+ fields about your business), Data Hub (upload any file — documents, PDFs, spreadsheets, images, voice notes, sales call recordings, competitor research, marketing materials), and Custom Skills (teach them your specific workflows step by step). Plus a 5-layer self-learning pipeline that automatically extracts insights from every task, peer feedback, weekly auto-research, knowledge refreshes, and monthly self-assessments. The longer you use them, the smarter they get.' },
