export default function Privacy() {
  ...
  return (
    <div>
      <section className="py-20 section-dark halftone"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h1 className="font-black text-5xl sm:text-6xl uppercase text-white">Privacy Policy</h1><p className="text-gray-500 mt-3">Last updated: April 12, 2026</p></div></section>
