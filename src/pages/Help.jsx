...
const categories = [
  ...
  },
  {
    ...
    qs: [
      ...
      { q: 'What social media platforms are supported?', a: 'Flora posts across TikTok, Instagram, Facebook, X (Twitter), YouTube, and LinkedIn via Zernio API. She has mandatory format specs for each platform (dimensions, character limits, hashtag rules). 10+ posts/day with optimal timing. AI-generated images via Gemini for every post. Remotion video pipeline for TikTok-native explainers and slideshow videos.' },
      ...
      { q: 'Can I connect external tools?', a: 'Yes — the Command Centre lets you build custom automations and create webhook endpoints for Zapier, Make, n8n, and any other tool. HMAC-SHA256 signed payloads, 11 event types, auto-disable after 10 consecutive failures. Plus Google Workspace APIs (Sheets, Drive, Docs) for document creation and data export.' },
      { q: 'How does lead discovery work?', a: 'Hugh finds leads from 7 free data sources: OpenStreetMap/Overpass, Google Places, social media via Gemini search grounding, directory scraping (LAPADA, BADA, Antiques Atlas), Wikidata SPARQL, website enrichment (emails, phones, social links). Covers 33 industry mappings from restaurants to real estate. Optional Companies House API. Deduplication via business name + postcode matching.' },
    ],
  },
  {
    name: 'Billing & Plans',
  ...
  },
  {
    ...
    icon: '🔒',
    qs: [
      { q: 'Is my data secure?', a: 'Yes. Bank-grade encryption in transit (TLS 1.3) and at rest (AES-256). Row-level security (RLS) at the database level means your data is completely isolated from other users. Access is strictly controlled and audited. GDPR compliant.' },
      ...
      { q: 'Where is my data stored?', a: 'Secure, encrypted Supabase databases with automatic backups. Enterprise-grade infrastructure. Multi-tenant architecture with row-level security ensuring complete data isolation between subscribers.' },
      { q: 'What about AI model privacy?', a: 'Your business data is used only to power YOUR employees. We use Gemini models via Google\'s API — your data is not used to train the underlying models. Conversations and business knowledge stay within your account.' },
    ],
  },
]
