...
const competitors = [
  { name: 'AI Employees', us: true, employees: '11', price: 'From $97', trial: '14 days', crossCollab: true, video: true, blog: true, email: true, analytics: true, legal: true, finance: true, leads: true, ads: true, research: true, training: true, whiteLabel: true },
  ...
  { name: 'Monday', us: false, employees: '0', price: '$9/seat', trial: '14 days', crossCollab: false, video: false, blog: false, email: true, analytics: true, legal: false, finance: false, leads: true, ads: false, research: false, training: false, whiteLabel: false },
]
    ...
    <div>
      ...
      <section className="py-20 section-neon">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-black/60 text-lg mb-8">Try AI Employees free for 14 days.</p>
